...
var (
	...
	Codecs = map[exchange.SerializeType]codec.Codec{
		exchange.SerializeNone: &codec.ByteCodec{},
		exchange.JSON:          &codec.JSONCodec{},
		exchange.ProtoBuffer:   &codec.PBCodec{},
		exchange.MsgPack:       &codec.MsgpackCodec{},
		exchange.Thrift:        &codec.ThriftCodec{},
	}
)
